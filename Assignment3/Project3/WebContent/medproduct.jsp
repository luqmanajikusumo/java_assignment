...
<title>Welcome to Medical Section</title>
<style>
	.header{
	padding: 10px;
...
<body>
<h3>Welcome to the Medical Section</h3>
<div class="container">
<form action="./totalmed" method="post">
<table>
  <tr>
    <th>ID</th>
    <th>Name</th>
  ...
  <tr>
    ...
    <td>${datamodel.name='Generic Drug'}</td>
  ...
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    ...
    <td><input type="checkbox" id="med" name="med" value="${datamodel.name='Generic Drug'}"></td>
    <td><input type="hidden" id="price2" name="price2" value="${datamodel.price=3000}"></td>
  </tr>
  <tr>
    <td>${datamodel.id=2}</td>
    <td>${datamodel.name='Supplement'}</td>
    <td><img style="width:150px;height:150px;" 
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    <td>${datamodel.price=10000}</td>
    <td><input type="checkbox" id="med" name="med" value="${datamodel.name='Supplement'}"></td>
    <td><input type="hidden" id="price2" name="price2" value="${datamodel.price=10000}"></td>
  </tr>
  <tr>
    <td>${datamodel.id=3}</td>
    <td>${datamodel.name='Hand Sanitizer'}</td>
    <td><img style="width:150px;height:150px;" 
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    <td>${datamodel.price=12000}</td>
    <td><input type="checkbox" id="med" name="med" value="${datamodel.name='Hand Sanitizer'}"></td>
