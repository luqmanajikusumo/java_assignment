...
<title>Welcome to Education Section</title>
<style>
	.header{
	padding: 10px;
...
<div class="container">
<!-- <form action="./totaledu" method="post"> -->
<form action="./totaledu" method="post">
<table>
  <tr>
    <th>ID</th>
  ...
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    ...
    <td><input type="checkbox" id="edu" name="edu" value="${datamodel.name='Book'}"></td>
    <td><input type="hidden" id="price2" name="price2" value="${datamodel.price=3000}"></td>
  </tr>
  <tr>
    <td>${datamodel.id=2}</td>
    <td>${datamodel.name='Drawing Book'}</td>
    <td><img style="width:150px;height:150px;" 
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    <td>${datamodel.price=3500}</td>
    <td><input type="checkbox" id="edu" name="edu" value="${datamodel.name='Drawing Book'}"></td>
    <td><input type="hidden" id="price2" name="price2" value="${datamodel.price=3500}"></td>
  </tr>
  <tr>
    <td>${datamodel.id=3}</td>
    <td>${datamodel.name='Ball Point Pen'}</td>
    <td><img style="width:150px;height:150px;" 
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    <td>${datamodel.price=1500}</td>
    <td><input type="checkbox" id="edu" name="edu" value="${datamodel.name='Ball Point Pen'}"></td>
    <td><input type="hidden" id="price2" name="price2" value="${datamodel.price=1500}"></td>
  </tr>
  <tr>
    <td>${datamodel.id=4}</td>
    <td>${datamodel.name='Crayon Set'}</td>
    <td><img style="width:150px;height:150px;" 
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    <td>${datamodel.price=10000}</td>
    <td><input type="checkbox" id="edu" name="edu" value="${datamodel.name='Crayon Set'}"></td>
    <td><input type="hidden" id="price2" name="price2" value="${datamodel.price=10000}"></td>
  </tr>
  <tr>
    <td>${datamodel.id=5}</td>
    <td>${datamodel.name='Ruler'}</td>
    <td><img style="width:150px;height:150px;" 
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    <td>${datamodel.price=4500}</td>
    <td><input type="checkbox" id="edu" name="edu" value="${datamodel.name='Ruler'}"></td>
    <td><input type="hidden" id="price2" name="price2" value="${datamodel.price=4500}"></td>
  </tr>
  <tr>
    <td>${datamodel.id=6}</td>
    <td>${datamodel.name='Protractor'}</td>
    <td><img style="width:150px;height:150px;" 
  src="E:/Fresh Start/Java and DB program/Project/Project3/src/${datamodel.name}.jpg"></td>
    <td>${datamodel.price=2000}</td>
    <td><input type="checkbox" id="edu" name="edu" value="${datamodel.name='Protractor'}"></td>
    <td><input type="hidden" id="price2" name="price2" value="${datamodel.price=2000}"></td>
  </tr>
  <tr>
